...
set ID 1
set hasByteEnable 0
set MemName maxPooling_pool_vbkb
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_V \
    op interface \
    ports { input_V_address0 { O 19 vector } input_V_ce0 { O 1 bit } input_V_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_V \
    op interface \
    ports { output_V_address0 { O 17 vector } output_V_ce0 { O 1 bit } output_V_we0 { O 1 bit } output_V_d0 { O 16 vector } } \
} "
} else {
